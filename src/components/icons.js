...
import { faPlug, faThLarge, faDownload, faUpload, faBatteryFull, faChargingStation, faArrowRight, faShip, faLeaf } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-3 col-sm-6 text-center white">
          ...
          <h6>Safe stable battery, greater battery cycle life: 25000+, higher power output</h6>
        </div>
      </div>
      <p></p>
      <div className="row">
